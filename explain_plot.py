...
counter = 0 #this is to maintain the chait id 



async def explain_plot(chat_session : chatlas.Chat, plot_widget : go.FigureWidget):
    try:
        ...
        global counter
        counter += 1
        chat_id = f"explain_plot_chart_{counter}"
